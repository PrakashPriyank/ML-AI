...
def contact():
    mess._show(title='Contact us', message="Please contact us on : 'bcet@gmail.com' ")
...
lbl3 = tk.Label(frame2, text="Enter Address",width=20  ,fg="black"  ,bg="#00aeff" ,font=('times', 17, ' bold '))
lbl3.place(x=80, y=223)

txt3 = tk.Entry(frame2,width=32 ,fg="black",font=('times', 15, ' bold ')  )
txt3.place(x=30, y=256)
